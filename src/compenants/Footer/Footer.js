                    ...
                    <div className="row display-flex">
                        <div className="col-md-5 col-11  ft-1">
                           <img src={`${process.env.PUBLIC_URL}/cinema.png`} alt="logo" className="logoF"/>
                            <p style={{ width: "80%" }}>Dive into cinematic enchantment with us! 🍿✨ Book tickets effortlessly, select prime seats, and indulge in the magic of movies. Cinema Ticket Booking — where each visit unfolds a story on the big screen. 🎬🎟️🌟 ~ Ankit Vishwakarma Gupta.</p>
                        ...
                        <div className="col-md-3 col-11 ft-3">
                            ...
                            <ul>
                                <li> <a href="tel:+212 6121324083">+91 90045692**</a></li>
